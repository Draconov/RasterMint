...
def test_every_backend_method_called_by_qml_exists_in_backend_class():
    ...
    # app.py exposes qmlui.preferences_backend.RasterMintBackend to QML. That
    # class subclasses qmlui.backend.RasterMintBackend, so the runtime backend
    # API is the union of methods defined by both classes.
    backend_files = [
