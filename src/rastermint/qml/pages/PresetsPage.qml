        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                Column {
                    ...
                    Rectangle {
                        width: parent.width; height: 104; radius: 5; color: theme.canvasColor; clip: true
                        Image {
                    ...
                    Text { width: parent.width; text: modelData.description; color: theme.mutedTextColor; font.pixelSize: 10; wrapMode: Text.WordWrap; maximumLineCount: 2; elide: Text.ElideRight }
                    Text {
                        width: parent.width
                        visible: modelData.hardwareProfileName !== ""
                        text: modelData.hardwareProfileName ? ("Hardware: " + modelData.hardwareProfileName) : ""
                ...
                ToolTip.text: modelData.hardwareProfileName
                    ? (modelData.description + "\nHardware: " + modelData.hardwareProfileName + " · " + modelData.hardwareMode)
                    : modelData.description
            }
        }
        RowLayout {
